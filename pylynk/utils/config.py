...
class Config:
    ...
    def __init__(self, args):
        ...
        self.token = getattr(args, 'token', None) or os.environ.get(ENV_SECURITY_TOKEN)
        ...
        self.include_support_status = getattr(args, 'include_support_status', False)
    ...
    def validate_token(self):
        ...
        if not self.token:
            ...
            print("Please set INTERLYNK_SECURITY_TOKEN environment variable or use --token parameter")
            return False
